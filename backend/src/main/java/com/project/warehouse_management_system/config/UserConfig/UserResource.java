...
public class UserResource {
    ...
    public List<User> getUsersByRole(@PathVariable("role") String roleName) {
        Keycloak keycloak = keycloakUtil.getKeycloakInstance();
        ...
        List<UserRepresentation> userReps = keycloak.realm(realm).roles()
                .get(role.getName()).getUserMembers();
